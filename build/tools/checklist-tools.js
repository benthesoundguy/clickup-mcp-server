...
export function setupChecklistTools(server) {
    ...
    server.tool('checklists_create', 'Create a new checklist in a ClickUp task. Returns the created checklist details.', {
    ...
    server.tool('checklists_update', 'Update an existing ClickUp checklist\'s name.', {
    ...
    server.tool('checklists_delete', 'Delete a checklist from a ClickUp task. Removes the checklist and all its items.', {
    ...
    server.tool('checklists_items_create', 'Create a new item in a ClickUp checklist. Supports optional assignee and resolved status.', {
    ...
    server.tool('checklists_items_update', 'Update an existing ClickUp checklist item\'s properties including name, assignee, and resolved status.', {
    ...
    server.tool('checklists_items_delete', 'Delete an item from a ClickUp checklist.', {
        checklist_id: z.string().describe('The ID of the checklist containing the item'),
