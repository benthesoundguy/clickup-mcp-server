...
export function setupAttachmentTools(server) {
    server.tool('attachments', 'Manage attachments on ClickUp tasks. Use "list" to see existing attachments, "create" to attach by URL, or "upload" to upload a file (base64-encoded).', {
            ...
            switch (action) {
                ...
                case 'upload': {
                    if (!file_data || !file_name)
                        throw new Error('file_data and file_name are required for upload');
