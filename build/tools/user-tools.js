...
export function setupUserTools(server) {
    server.tool('users_list', 'List all users in a ClickUp workspace.', {
    ...
    server.tool('users_invite', 'Invite a user to a ClickUp workspace by email.', {
        workspace_id: z.string().describe('The ID of the workspace'),
    ...
    server.tool('users_update', "Update a user's details in the workspace.", {
        workspace_id: z.string().describe('The ID of the workspace'),
    ...
    server.tool('users_remove', 'Remove a user from a ClickUp workspace.', {
        workspace_id: z.string().describe('The ID of the workspace'),
