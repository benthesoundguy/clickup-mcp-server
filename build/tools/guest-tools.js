...
export function setupGuestTools(server) {
    server.tool('guests_invite', 'Invite a guest to a ClickUp workspace.', {
    ...
    server.tool('guests_get', 'Get details about a specific guest in the workspace.', {
        workspace_id: z.string().describe('The ID of the workspace'),
    ...
    server.tool('guests_update', 'Update a guest\'s permissions or details in the workspace.', {
        workspace_id: z.string().describe('The ID of the workspace'),
        guest_id: z.number().describe('The ID of the guest'),
        can_edit_tags: z.boolean().optional().describe('Whether the guest can edit tags')
    ...
    server.tool('guests_remove', 'Remove a guest from the workspace entirely.', {
        workspace_id: z.string().describe('The ID of the workspace'),
    ...
    server.tool('guests_attach', 'Grant a guest access to a specific location (task, list, or folder).', {
        guest_id: z.number().describe('The ID of the guest'),
    ...
    server.tool('guests_detach', 'Remove a guest\'s access from a task, list, or folder.', {
        guest_id: z.number().describe('The ID of the guest'),
        location_type: z.enum(['task', 'list', 'folder']).describe('The type of location'),
        location_id: z.string().describe('The ID of the task, list, or folder')
...
//# sourceMappingURL=guest-tools.js.map